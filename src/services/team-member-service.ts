...
export default class TeamMemberService {
  ...
  public async createOrUpdate(
    ...
    const response = await this.fetchImpl(`/teams/${teamIdentity}/members`, {
      ...requestInit,
  ...
  public async delete(
    ...
    const response = await this.fetchImpl(`/teams/${teamIdentity}/members/${teamMemberIdentity}`, {
      ...requestInit,
  ...
  public async listByMember(
    ...
    const response = await this.fetchImpl(`/teams/${teamIdentity}/members/${teamMemberIdentity}/apps`, {
      ...requestInit,

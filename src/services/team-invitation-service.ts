...
export default class TeamInvitationService {
  ...
  public async list(
    ...
    const response = await this.fetchImpl(`/teams/${teamName}/invitations`, {
      ...requestInit,
  ...
  public async create(
    ...
    const response = await this.fetchImpl(`/teams/${teamIdentity}/invitations`, {
      ...requestInit,
  ...
  public async revoke(
    ...
    const response = await this.fetchImpl(`/teams/${teamIdentity}/invitations/${teamInvitationIdentity}`, {
      ...requestInit,
  ...
  public async get(
    ...
    const response = await this.fetchImpl(`/teams/invitations/${teamInvitationToken}`, {
      ...requestInit,
  ...
  public async accept(
    ...
    const response = await this.fetchImpl(`/teams/invitations/${teamInvitationToken}/accept`, {
      ...requestInit,

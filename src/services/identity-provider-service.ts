...
export default class IdentityProviderService {
  ...
  public async listByTeam(
    ...
    const response = await this.fetchImpl(`/teams/${teamName}/identity-providers`, {
      ...requestInit,
  ...
  public async updateByTeam(
    ...
    const response = await this.fetchImpl(`/teams/${teamName}/identity-providers/${identityProviderId}`, {
      ...requestInit,
      body: JSON.stringify(payload, null, 2),
      method: 'PATCH',
      headers: {

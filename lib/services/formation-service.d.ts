 ...
 */
    info(appIdentity: string, formationIdentity: string): Promise<Heroku.Formation>;
    /**
     * List process type formation
     *
     * @param appIdentity unique identifier of app or unique name of app.
     */
    list(appIdentity: string): Promise<Heroku.Formation[]>;
    /**
     ...
     */
    batchUpdate(appIdentity: string, body: Heroku.FormationBatchUpdatePayload): Promise<Heroku.Formation[]>;
    /**
     * Update process type
     *
     * @param appIdentity unique identifier of app or unique name of app.
     ...
     * @param body Object to send to the endpoint.
     */
    update(appIdentity: string, formationIdentity: string, body: Heroku.FormationUpdatePayload): Promise<Heroku.Formation>;
}

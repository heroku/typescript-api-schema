...
export default class OauthClientService {
    ...
    async create(payload, requestInit = {}) {
        const response = await this.fetchImpl(`/oauth/clients`, {
            ...requestInit,
    ...
    async delete(oauthClientIdentity, requestInit = {}) {
        const response = await this.fetchImpl(`/oauth/clients/${oauthClientIdentity}`, {
            ...requestInit,
            method: 'DELETE',
            headers: {
                ...requestInit?.headers,
    ...
    async rotateCredentials(oauthClientIdentity, requestInit = {}) {
        const response = await this.fetchImpl(`/oauth/clients/${oauthClientIdentity}/actions/rotate-credentials`, {
            ...requestInit,
            method: 'POST',
            headers: {
                ...requestInit?.headers,

...
export default class CollaboratorService {
    ...
    async create(appIdentity, payload, requestInit = {}) {
        const response = await this.fetchImpl(`/apps/${appIdentity}/collaborators`, {
            ...requestInit,
    ...
    async delete(appIdentity, collaboratorIdentity, requestInit = {}) {
        const response = await this.fetchImpl(`/apps/${appIdentity}/collaborators/${collaboratorIdentity}`, {
            ...requestInit,
            method: 'DELETE',
            headers: {
                ...requestInit?.headers,

...
export default class ReviewAppService {
    ...
    async create(payload, requestInit = {}) {
        const response = await this.fetchImpl(`/review-apps`, {
            ...requestInit,
    ...
    async getReviewApp(reviewAppId, requestInit = {}) {
        const response = await this.fetchImpl(`/review-apps/${reviewAppId}`, {
            ...requestInit,
            method: 'GET',
            headers: {
                ...requestInit?.headers,
    ...
    async getReviewAppByAppId(appIdentity, requestInit = {}) {
        const response = await this.fetchImpl(`/apps/${appIdentity}/review-app`, {
            ...requestInit,
            method: 'GET',
            headers: {
                ...requestInit?.headers,
    ...
    async list(pipelineId, requestInit = {}) {
        const response = await this.fetchImpl(`/pipelines/${pipelineId}/review-apps`, {
            ...requestInit,
            method: 'GET',
            headers: {
                ...requestInit?.headers,

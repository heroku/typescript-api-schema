...
export interface EnterpriseAccountMemberCreatePayload {
    ...
    * @example view
    */
    readonly permissions: 'view' | 'create' | 'manage' | 'billing'[];
    /**
...
export interface OutboundRuleset {
    ...
    */
     ...
     * identity of space
    */
    space: OutboundRulesetSpace;
    /**
     * when outbound-ruleset was created
    * @example 2012-01-01T12:00:00Z
    */
    readonly created_at: string;
    rules: OutboundRulesetRule[];
    /**
     * unique email address of account
    * @example username@example.com
    */
 ...
 * identity of space
 */
export interface OutboundRulesetSpace {
    /**
     * unique identifier of space
    * @example 01234567-89ab-cdef-0123-456789abcdef
    */
...
export interface OutboundRulesetCreatePayload {
    rules?: OutboundRulesetCreatePayloadRule[];
}
/**
 *
 * the combination of an IP address in CIDR notation, a from_port, to_port and protocol.
 */
export interface OutboundRulesetCreatePayloadRule {
    /**
     * is the target destination in CIDR notation
    * @example 1.1.1.1/1
    */

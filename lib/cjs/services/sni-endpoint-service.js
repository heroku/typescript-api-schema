...
class SniEndpointService {
    ...
    async create(appIdentity, payload, requestInit = {}) {
        const response = await this.fetchImpl(`/apps/${appIdentity}/sni-endpoints`, {
            ...requestInit,
    ...
    async delete(appIdentity, sniEndpointIdentity, requestInit = {}) {
        const response = await this.fetchImpl(`/apps/${appIdentity}/sni-endpoints/${sniEndpointIdentity}`, {
            ...requestInit,
            method: 'DELETE',
            headers: {
                ...requestInit?.headers,
...
exports.default = SniEndpointService;

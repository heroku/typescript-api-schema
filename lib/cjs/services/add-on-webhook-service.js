...
class AddOnWebhookService {
    ...
    async create(addOnIdentity, payload, requestInit = {}) {
        const response = await this.fetchImpl(`/addons/${addOnIdentity}/webhooks`, {
            ...requestInit,
    ...
    async delete(addOnIdentity, appWebhookIdentity, requestInit = {}) {
        const response = await this.fetchImpl(`/addons/${addOnIdentity}/webhooks/${appWebhookIdentity}`, {
            ...requestInit,
            method: 'DELETE',
            headers: {
                ...requestInit?.headers,
...
exports.default = AddOnWebhookService;

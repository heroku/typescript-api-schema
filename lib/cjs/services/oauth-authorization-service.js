...
class OauthAuthorizationService {
    ...
    async create(payload, requestInit = {}) {
        const response = await this.fetchImpl(`/oauth/authorizations`, {
            ...requestInit,
    ...
    async delete(oauthAuthorizationIdentity, requestInit = {}) {
        const response = await this.fetchImpl(`/oauth/authorizations/${oauthAuthorizationIdentity}`, {
            ...requestInit,
            method: 'DELETE',
            headers: {
                ...requestInit?.headers,
    ...
    async regenerate(oauthAuthorizationIdentity, requestInit = {}) {
        const response = await this.fetchImpl(`/oauth/authorizations/${oauthAuthorizationIdentity}/actions/regenerate-tokens`, {
            ...requestInit,
            method: 'POST',
            headers: {
                ...requestInit?.headers,

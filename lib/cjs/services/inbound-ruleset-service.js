...
class InboundRulesetService {
    ...
    async current(spaceIdentity, requestInit = {}) {
        const response = await this.fetchImpl(`/spaces/${spaceIdentity}/inbound-ruleset`, {
            ...requestInit,
            method: 'GET',
            headers: {
                ...requestInit?.headers,
    ...
    async info(spaceIdentity, inboundRulesetIdentity, requestInit = {}) {
        const response = await this.fetchImpl(`/spaces/${spaceIdentity}/inbound-rulesets/${inboundRulesetIdentity}`, {
            ...requestInit,
            method: 'GET',
            headers: {
                ...requestInit?.headers,
    ...
    async list(spaceIdentity, requestInit = {}) {
        const response = await this.fetchImpl(`/spaces/${spaceIdentity}/inbound-rulesets`, {
            ...requestInit,
            method: 'GET',
            headers: {
                ...requestInit?.headers,

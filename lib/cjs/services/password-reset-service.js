...
class PasswordResetService {
    ...
    async resetPassword(payload, requestInit = {}) {
        const response = await this.fetchImpl(`/password-resets`, {
            ...requestInit,
    ...
    async completeResetPassword(passwordResetResetPasswordToken, payload, requestInit = {}) {
        const response = await this.fetchImpl(`/password-resets/${passwordResetResetPasswordToken}/actions/finalize`, {
            ...requestInit,
            body: JSON.stringify(payload, null, 2),
            method: 'POST',
            headers: {

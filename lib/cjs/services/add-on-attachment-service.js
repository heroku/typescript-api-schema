...
class AddOnAttachmentService {
    ...
    async create(payload, requestInit = {}) {
        const response = await this.fetchImpl(`/addon-attachments`, {
            ...requestInit,
    ...
    async delete(addOnAttachmentIdentity, requestInit = {}) {
        const response = await this.fetchImpl(`/addon-attachments/${addOnAttachmentIdentity}`, {
            ...requestInit,
            method: 'DELETE',
            headers: {
                ...requestInit?.headers,
    ...
    async listByAddOn(addOnIdentity, requestInit = {}) {
        const response = await this.fetchImpl(`/addons/${addOnIdentity}/addon-attachments`, {
            ...requestInit,
            method: 'GET',
            headers: {
                ...requestInit?.headers,
    ...
    async listByApp(appIdentity, requestInit = {}) {
        const response = await this.fetchImpl(`/apps/${appIdentity}/addon-attachments`, {
            ...requestInit,
            method: 'GET',
            headers: {
                ...requestInit?.headers,
    ...
    async infoByApp(appIdentity, addOnAttachmentScopedIdentity, requestInit = {}) {
        const response = await this.fetchImpl(`/apps/${appIdentity}/addon-attachments/${addOnAttachmentScopedIdentity}`, {
            ...requestInit,
            method: 'GET',
            headers: {
                ...requestInit?.headers,
    ...
    async resolution(payload, requestInit = {}) {
        const response = await this.fetchImpl(`/actions/addon-attachments/resolve`, {
            ...requestInit,
            body: JSON.stringify(payload, null, 2),
            method: 'POST',
            headers: {

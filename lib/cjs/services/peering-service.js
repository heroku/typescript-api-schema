...
class PeeringService {
    ...
    async list(spaceIdentity, requestInit = {}) {
        const response = await this.fetchImpl(`/spaces/${spaceIdentity}/peerings`, {
            ...requestInit,
            method: 'GET',
            headers: {
                ...requestInit?.headers,
    ...
    async accept(spaceIdentity, peeringPcxId, requestInit = {}) {
        const response = await this.fetchImpl(`/spaces/${spaceIdentity}/peerings/${peeringPcxId}/actions/accept`, {
            ...requestInit,
            method: 'POST',
            headers: {
                ...requestInit?.headers,
    ...
    async destroy(spaceIdentity, peeringPcxId, requestInit = {}) {
        const response = await this.fetchImpl(`/spaces/${spaceIdentity}/peerings/${peeringPcxId}`, {
            ...requestInit,
            method: 'DELETE',
            headers: {
                ...requestInit?.headers,
...
exports.default = PeeringService;

...
class TeamService {
    ...
    async list(requestInit = {}) {
        const response = await this.fetchImpl(`/teams`, {
            ...requestInit,
            method: 'GET',
            headers: {
                ...requestInit?.headers,
    ...
    async info(teamIdentity, requestInit = {}) {
        const response = await this.fetchImpl(`/teams/${teamIdentity}`, {
            ...requestInit,
            method: 'GET',
            headers: {
                ...requestInit?.headers,
    ...
    async listByEnterpriseAccount(enterpriseAccountIdentity, requestInit = {}) {
        const response = await this.fetchImpl(`/enterprise-accounts/${enterpriseAccountIdentity}/teams`, {
            ...requestInit,
            method: 'GET',
            headers: {
                ...requestInit?.headers,

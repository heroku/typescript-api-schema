 ...
 */
class EnterpriseAccountDailyUsageService {
    fetchImpl;
    ...
    async info(enterpriseAccountId, payload, requestInit = {}) {
        const response = await this.fetchImpl(`/enterprise-accounts/${enterpriseAccountId}/usage/daily`, {
            ...requestInit,
...
exports.default = EnterpriseAccountDailyUsageService;

...
class AddOnServiceService {
    ...
    async info(addOnServiceIdentity, requestInit = {}) {
        const response = await this.fetchImpl(`/addon-services/${addOnServiceIdentity}`, {
            ...requestInit,
            method: 'GET',
            headers: {
                ...requestInit?.headers,
    ...
    async list(requestInit = {}) {
        const response = await this.fetchImpl(`/addon-services`, {
            ...requestInit,
            method: 'GET',
            headers: {
                ...requestInit?.headers,
...
exports.default = AddOnServiceService;

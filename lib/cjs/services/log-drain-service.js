...
class LogDrainService {
    ...
    async create(appIdentity, payload, requestInit = {}) {
        const response = await this.fetchImpl(`/apps/${appIdentity}/log-drains`, {
            ...requestInit,
    ...
    async update(addOnIdentity, logDrainQueryIdentity, payload, requestInit = {}) {
        const response = await this.fetchImpl(`/addons/${addOnIdentity}/log-drains/${logDrainQueryIdentity}`, {
            ...requestInit,
            body: JSON.stringify(payload, null, 2),
            method: 'PUT',
            headers: {
    ...
    async delete(appIdentity, logDrainQueryIdentity, requestInit = {}) {
        const response = await this.fetchImpl(`/apps/${appIdentity}/log-drains/${logDrainQueryIdentity}`, {
            ...requestInit,
            method: 'DELETE',
            headers: {
                ...requestInit?.headers,
    ...
    async listByAddOn(addOnIdentity, requestInit = {}) {
        const response = await this.fetchImpl(`/addons/${addOnIdentity}/log-drains`, {
            ...requestInit,
            method: 'GET',
            headers: {
                ...requestInit?.headers,
...
exports.default = LogDrainService;

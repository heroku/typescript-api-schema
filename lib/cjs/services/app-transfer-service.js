...
class AppTransferService {
    ...
    async create(payload, requestInit = {}) {
        const response = await this.fetchImpl(`/account/app-transfers`, {
            ...requestInit,
    ...
    async delete(appTransferIdentity, requestInit = {}) {
        const response = await this.fetchImpl(`/account/app-transfers/${appTransferIdentity}`, {
            ...requestInit,
            method: 'DELETE',
            headers: {
                ...requestInit?.headers,
...
exports.default = AppTransferService;

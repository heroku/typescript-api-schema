...
class TeamAppCollaboratorService {
    ...
    async create(appIdentity, payload, requestInit = {}) {
        const response = await this.fetchImpl(`/teams/apps/${appIdentity}/collaborators`, {
            ...requestInit,
    ...
    async delete(teamAppIdentity, teamAppCollaboratorIdentity, requestInit = {}) {
        const response = await this.fetchImpl(`/teams/apps/${teamAppIdentity}/collaborators/${teamAppCollaboratorIdentity}`, {
            ...requestInit,
            method: 'DELETE',
            headers: {
                ...requestInit?.headers,
    ...
    async list(teamAppIdentity, requestInit = {}) {
        const response = await this.fetchImpl(`/teams/apps/${teamAppIdentity}/collaborators`, {
            ...requestInit,
            method: 'GET',
            headers: {
                ...requestInit?.headers,

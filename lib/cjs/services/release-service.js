...
class ReleaseService {
    ...
    async info(appIdentity, releaseIdentity, requestInit = {}) {
        const response = await this.fetchImpl(`/apps/${appIdentity}/releases/${releaseIdentity}`, {
            ...requestInit,
            method: 'GET',
            headers: {
                ...requestInit?.headers,
    ...
    async list(appIdentity, requestInit = {}) {
        const response = await this.fetchImpl(`/apps/${appIdentity}/releases`, {
            ...requestInit,
            method: 'GET',
            headers: {
                ...requestInit?.headers,
...
exports.default = ReleaseService;

...
class AddOnActionService {
    ...
    async provision(addOnIdentity, requestInit = {}) {
        const response = await this.fetchImpl(`/addons/${addOnIdentity}/actions/provision`, {
            ...requestInit,
            method: 'POST',
            headers: {
                ...requestInit?.headers,
    ...
    async deprovision(addOnIdentity, requestInit = {}) {
        const response = await this.fetchImpl(`/addons/${addOnIdentity}/actions/deprovision`, {
            ...requestInit,
            method: 'POST',
            headers: {
                ...requestInit?.headers,

 ...
 */
class EnterpriseAccountMonthlyUsageService {
    fetchImpl;
    ...
    async info(enterpriseAccountId, payload, requestInit = {}) {
        const response = await this.fetchImpl(`/enterprise-accounts/${enterpriseAccountId}/usage/monthly`, {
            ...requestInit,
...
exports.default = EnterpriseAccountMonthlyUsageService;

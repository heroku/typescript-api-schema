...
class DynoService {
    ...
    async create(appIdentity, payload, requestInit = {}) {
        const response = await this.fetchImpl(`/apps/${appIdentity}/dynos`, {
            ...requestInit,
    ...
    async restart(appIdentity, dynoIdentity, requestInit = {}) {
        const response = await this.fetchImpl(`/apps/${appIdentity}/dynos/${dynoIdentity}`, {
            ...requestInit,
            method: 'DELETE',
            headers: {
                ...requestInit?.headers,
    ...
    async stop(appIdentity, dynoIdentity, requestInit = {}) {
        const response = await this.fetchImpl(`/apps/${appIdentity}/dynos/${dynoIdentity}/actions/stop`, {
            ...requestInit,
            method: 'POST',
            headers: {
                ...requestInit?.headers,
